...
/**
 * This is the model class for table "jalur_prestasi".
 *
 * @property int $id
 ...
 */
class JalurPrestasi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Prestasi::className(), ['id_jalur_prestasi' => 'id']);
    }
