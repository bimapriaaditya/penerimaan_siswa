...
/**
 * JalurPrestasiSearch represents the model behind the search form of `app\models\JalurPrestasi`.
 */
class JalurPrestasiSearch extends JalurPrestasi
{
    /**
     * {@inheritdoc}
     */
